...
function History() {
  ...
  const { setModalMovie } = useAppContext(); // ✅ get setter from context

  return (
    <div className='relative'>
      <h1 className='text-white font-bold text-2xl py-8 ml-8'>History</h1>
      ...
      <div
        ref={scrollRef}
        className='flex overflow-x-auto overflow-y-hidden gap-6 px-8 pb-8 pt-8 hide-scrollbar scroll-smooth'
      >
        {loading ? (
          ...
          movies.map((movie) => (
            <div
              ...
              onClick={() => setModalMovie(movie)} // ✅ open modal click
            >
