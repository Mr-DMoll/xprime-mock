...
function Adventure() {
  ...
  const { setModalMovie } = useAppContext(); // from context
        ...
        {loading ? (
          ...
          movies.map((movie) => (
            <div
              ...
              onClick={() => setModalMovie(movie)} // ✅ open modal
            >
              <div className='w-full aspect-[2/3] overflow-hidden shadow-md transition-transform duration-300 group-hover:scale-110'>
                <img
